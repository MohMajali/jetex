...
class _InfoScreenState extends State<InfoScreen> {
  ...
  void setdata() async {
    ...
    setState(() {
      ...
      nameEn = sharedPreferences.getString('storeNameEn');
      nameAr = sharedPreferences.getString('storeNameAr');
  ...
  Future<bool> phonealertDialog() {
    Future<String> Insert(Phone ph) async {
      var ure =
          Uri.http('45.76.132.167', '/api/authentication/updatedatainfo.php');
      ...
      print(xbody);
      final response = await http.post(ure,
          body: jsonEncode(xbody),
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        ...
                        Insert(inf);
                        setState(() {
                          sharedPreferences.setString('name_en', inf.nameEn);
